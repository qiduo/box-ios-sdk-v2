...
/**
 * BoxUsersRequestBuilder is an abstract base class for building API requests relating
 * to subclasses of BoxUser. Because this class is abstract, you should not instantiate
